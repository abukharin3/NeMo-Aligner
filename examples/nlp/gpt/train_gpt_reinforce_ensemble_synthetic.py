...
from nemo_aligner.algorithms.reinforce_ensemble_synthetic import ReinforceHackerSynthetic
...
from nemo_aligner.models.nlp.gpt.reward_critic_clients import RemoteGPTRMClient, RemoteHFRMClient
...
def main(cfg) -> None:
    ...
    rm_critic_gt = RemoteGPTRMClient(cfg.remote_critic_rm_gt)
    ...
    reinforce_trainer = ReinforceHackerSynthetic(
