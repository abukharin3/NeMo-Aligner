...
from nemo_aligner.algorithms.reinforce_api_rm import ReinforceAPIRMTrainer
...
from nemo_aligner.models.nlp.gpt.reward_critic_clients import RemoteAPIRMClient
...
def main(cfg) -> None:
    ...
    rm = RemoteAPIRMClient(cfg.remote_rm)
    ...
    reinforce_trainer = ReinforceAPIRMTrainer(
